 ...
 * @author Mukund
 */
public class User_swim_book extends javax.swing.JFrame {
...
ResultSet rs=null;
    ...
    /**
     * Creates new form User_swim_book
     */
    public User_swim_book() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Enroll for Swimming");
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "BATCH A- 6 AM TO 9 AM", "BATCH B- 12 NOON TO 3 PM", "BATCH C- 4 PM TO 7 PM" }));
    ...
    batch="B";
        ...
        batch="C";
    String sql="insert into swimming(first_name,last_name,flat_number,start_date,end_date,amount,duration,batch) values('"+f_name+"','"+l_name+"',"+uflat+",'"+dateA+"','"+dateB+"',"+amt+",'"+plan+"','"+batch+"')";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(User_swim_book.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
